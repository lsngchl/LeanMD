...
y^0:=(q_1,\ldots,q_m).
\]
At this straight chain, the bordered matrix in \((\mathrm{ND})\) is invertible ([Nondegeneracy at a Straight Chain](./straight_chain_nondegeneracy.md "why")).
...
At this bent chain, the bordered matrix in \((\mathrm{ND})\) is invertible ([Nondegeneracy at a Bent Chain](./bent_chain_nondegeneracy.md "why")).
