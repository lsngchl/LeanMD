...
\]
The expression \(\delta(g(y)-r)\) is rigorously defined as the [distributional pullback](distributional_pullback/distributional_pullback.md "why") of the Dirac delta at \(r\) under \(g\).
Equivalently,
\[
