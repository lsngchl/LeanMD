...
The key linear-algebra input is that the mixed Hessian has rank \(md-1\), with its right and left kernels supported in the first and last endpoint directions, respectively ([Kernel of the Bent-Chain Mixed Hessian](bent_chain_mixed_hessian_kernel/bent_chain_mixed_hessian_kernel.md "why")).
