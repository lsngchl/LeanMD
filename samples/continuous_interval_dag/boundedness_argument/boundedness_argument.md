...
[루트 문서에서 정한 유계성의 정의](../continuous_interval_consequences.md "recall")에
...
[닫힌 구간의 부분수열 보조정리](bolzano_weierstrass_subsequence/bolzano_weierstrass_subsequence.md "why")에
...
가 된다. 이제 [연속성의 수열 판정](sequential_continuity/sequential_continuity.md "why")을
